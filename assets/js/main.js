...
let closes = function (modalClick){
...
modalCloses.forEach((closeBtn, i)=>{
...
const $ButtonMailTo=document.querySelector('#email__info');
...
function handleSubmit(event) {
  ...
  $ButtonMailTo.setAttribute('href', `mailto:nico.sierra13@gmail.com?subject=${form.get('name')} - ${form.get('email')}&body=${form.get('message')}`)
  $ButtonMailTo.click()
}